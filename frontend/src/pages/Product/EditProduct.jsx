...
import { updateProduct } from "../../components/redux/slice/product";
  ...
  return (
    <div className="bg-slate-900 w-[400px] mx-auto my-[100px] text-white flex justify-center items-center p-12 rounded-2xl">
      <form onSubmit={formik.handleSubmit} className="w-full">
        ...
        <h1 className="font-serif text-2xl mb-6 text-center">Edit Product</h1>
        ...
        <div className="flex flex-col items-center justify-center mt-6">
          <Button colorType="primary">Update Product</Button>
        </div>
      </form>
    </div>
  );
